...
<head>
	...
	<script type="text/javascript" src="/DMZ/LeftModual.js"></script>
...
<s:iterator value="dmzModules" status="st" var="obj">
	<input type="hidden" name="level" id="level<s:property value="#obj.tid" />" value="<s:property value="#obj.level" />" >
	<input type="hidden" name="tid" id="tid<s:property value="#obj.tid" />" value="<s:property value="#obj.tid" />" >
	<input type="hidden" name="name" id="name<s:property value="#obj.tid" />" value="<s:property value="#obj.name" />" >
	<input type="hidden" name="upId" id="upId<s:property value="#obj.tid" />" value="<s:property value="#obj.upId" />" >
</s:iterator>
</body>
<script>
