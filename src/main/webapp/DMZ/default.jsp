...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dmz/css/common.css" />

	<link rel="stylesheet" type="text/css" href="css/bootstrap-switch.min.css" />

	<!--  图片点击放大插件lightbox -->
	<link href="css/lightbox.css" rel="stylesheet" type="text/css" />
	<!--   树形菜单插件tree-multiselect      -->
	<link href="css/jquery.tree-multiselect.min.css" rel="stylesheet" type="text/css" />
	<!--滚动条插件-->
		...
		<ul class="nav navbar-nav pull-right">
			<li class="dropdown">
				...
				<ul class="dropdown-menu skins">
					<li class="dropdown-title">
						<span><i class="fa fa-leaf"></i>主题样式</span>
					</li>
			...
			<li class="dropdown user" id="header-user">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					...
					<span class="username">岱山县地名办</span>
					<i class="fa fa-angle-down"></i>
				</a>
	...
	<div id="sidebar" class="sidebar">
		<div class="sidebar-menu nav-collapse">
			...
			<ul id="modual">
				<li>
					<a href="index.html">
						<i class="fa fa-bookmark-o fa-fw"></i> <span class="menu-text">岱山县政区图</span>
				...
				<li class="has-sub">
					...
					<ul class="sub">
						<li class="has-sub-sub">
							<a href="javascript:;" class=""><span class="sub-menu-text">第一章 高亭镇</span>
								<span class="arrow"></span>
							</a>
							<ul class="sub-sub">
								<li><a class="" href="#"><span class="sub-sub-menu-text">第一节 概况</span></a></li>
								<li><a class="" href="#"><span class="sub-sub-menu-text">第二节 城镇社区</span></a></li>
							</ul>
						</li>
						<li class="has-sub-sub">
							<a href="javascript:;" class=""><span class="sub-menu-text">第二章 岱东镇</span>
								<span class="arrow"></span>
							</a>
							<ul class="sub-sub">
								<li><a class="" href="#"><span class="sub-sub-menu-text">第一节 概况</span></a></li>
						...
						<li class="has-sub-sub">
							<a href="javascript:;" class=""><span class="sub-menu-text">第三章 东沙镇</span>
								<span class="arrow"></span>
							</a>
							<ul class="sub-sub">
								<li><a class="" href="#"><span class="sub-sub-menu-text">第一节 概况</span></a></li>
							...
							<div class="page-header">
								...
								<div class="clearfix">
									...
									<!-- DATE RANGE PICKER -->
											...
											<div class="btn-group">
												<a class="js_update btn btn-default" href="#">关键字查询</a>
												<a class="js_update btn btn-default" href="#" data-toggle="modal" data-target="#outputModal">导出文本</a>
												<a class="js_update btn btn-default" href="#">
													<i class="fa  fa-plus"></i>添加条目
												</a>
												<a class="js_update btn btn-default hidden-xs" href="#">编辑记录</a>
							...
							<div class="box border  blue">
								...
								<div class="box-body">
									<div class="scroller" data-height="120px">
										...
										<div class="row">
											<div class="col-sm-4">
												<a href="img/gallery/1.png" data-lightbox="image-1" data-title="My caption">
													<img src="img/gallery/1.png" style="width: 100%;,height: 100%;" />
												</a>
											</div>
											<div class="col-sm-4">
												<a href="img/gallery/2.jpg" data-lightbox="image-1" data-title="My caption">
													<img src="img/gallery/2.jpg" style="width: 100%;,height: 100%;" />
												</a>
											</div>
											<div class="col-sm-4">
												<a href="img/gallery/3.png" data-lightbox="image-1" data-title="My caption">
													<img src="img/gallery/3.png" style="width: 100%;,height: 100%;" />
												</a>
											</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="#textEditTab" data-toggle="tab"><i class="fa  fa-pencil"></i> <span class="hidden-inline-mobile">文本编辑</span></a></li>
					<li><a href="#mediaEditTab" data-toggle="tab"><i class="fa fa-picture-o"></i> <span class="hidden-inline-mobile">多媒体库</span></a></li>
					<li><a href="#historyEditTab" data-toggle="tab"><i class="fa fa-save"></i> <span class="hidden-inline-mobile">历史编辑记录</span></a></li>
				</ul>
			</div>
			<div class="modal-body">
				<div class="tab-content">
					<div class="tab-pane fade in active" id="textEditTab">
						<form class="form-horizontal" role="form">
							<div class="form-group">
								...
								<label class="col-sm-6 control-label textLeft">根据地名代码自动导入地名志的地名含义、沿革、地理实体内容</label>
							</div>
							<div class="form-group">
								<label  class="col-sm-2 control-label">地名</label>
								<div class="col-sm-5">
						...
						<form class="form-horizontal" role="form">
							<div class="form-group">
								...
								<div class="col-sm-offset-1 col-sm-4">
									...
									<button class="btn btn-primary" type="button" onclick="javascript:$('#icon').trigger('click')">
										<i class="fa fa-plus"></i> 添加多媒体
									</button> 
									<input class="hidden" type="file" accept="image/jpeg" id="icon" name="img" />
								</span>
								</div>
							</div>
						</form>
					...
					<div class="tab-pane fade" id="historyEditTab">
						<table id="historyEditTab-datatable" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
							<thead>
							<tr>
...
<s:iterator value="dmzModulEntities" status="st" var="obj">
    <input type="hidden" name="id" id="priId<s:property value="#obj.id" />" value="<s:property value="#obj.id" />" >
    <input type="hidden" name="name" id="name<s:property value="#obj.id" />" value="<s:property value="#obj.name" />" >
    <input type="hidden" name="upId" id="upId<s:property value="#obj.id" />" value="<s:property value="#obj.upId" />" >
</s:iterator>
<!--/PAGE -->
<!-- JAVASCRIPTS -->
...
<script type="text/javascript" src="js/jquery/slimScrollHorizontal.min.js"></script>
<script type="text/javascript" src="dmz/js/basic.js"></script>
<script type="text/javascript" src="dmz/js/common.js"></script>
<!--   图片插件lightbox     -->
...
<script src="dmz/js/treeview.js"></script>
<!--滚动条插件  -->
...
<script src="dmz/js/setCustomScrollBar.js"></script>
<!--table插件，一次显示10行-->
